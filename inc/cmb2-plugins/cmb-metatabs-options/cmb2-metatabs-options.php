...
class Cmb2_Metatabs_Options {
	...
	private function validate_props( $id ) {
		...
		if ( ! self::$props[ $id ]['jsuri'] ) {
			self::$props[ $id ]['jsuri'] = get_template_directory_uri() . '/inc/cmb2-plugins/cmb-metatabs-options/cmb2multiopts.js';
			//self::$props[ $id ]['jsuri'] = CMB_PLUGINS . '/cmb-metatabs-options/cmb2multiopts.js';
